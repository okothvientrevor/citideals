  ...
  static List<AuctionItem> getTrendingItems() {
    return [
      AuctionItem(
        ...
        imageUrls: ['https://images.unsplash.com/photo-1622434641406-a158123450f9?w=800'],
        currentBid: 42500,
        startingBid: 35000,
      ...
      AuctionItem(
        ...
        imageUrls: ['https://images.unsplash.com/photo-1606933248010-ef1f33db8e44?w=800'],
        currentBid: 12000,
        startingBid: 8000,
  ...
  static List<AuctionItem> getLiveAuctions() {
    return [
      ...
      AuctionItem(
        ...
        imageUrls: ['https://images.unsplash.com/photo-1587836374828-4dbafa94cf0e?w=800'],
        currentBid: 185000,
        startingBid: 150000,
  ...
  static List<AuctionItem> getFeaturedItems() {
    return [
      ...
      AuctionItem(
        ...
        imageUrls: ['https://images.unsplash.com/photo-1547826039-bfc35e0f1ea8?w=800'],
        currentBid: 45000,
        startingBid: 35000,
      ...
      AuctionItem(
        ...
        imageUrls: ['https://images.unsplash.com/photo-1614164185128-e4ec99c436d7?w=800'],
        currentBid: 58000,
        startingBid: 50000,
